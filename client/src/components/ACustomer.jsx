...
export default function ACustomer(props) {
  ...
  function handleEditButtonClick() {
    props.onEditButtonClick(customer);
  }
  ...
  function handleModalButtonClick(event) {
    ...
    props.onDeleteButtonClick(ans, customer);
  }
  ...
  return (
    <>
      ...
      {flagDeleteButtonPressed && (
        <Modal
          modalText={
            'Do you really want to delete data of "' + customer.name + '".'
          }
          btnGroup={["Yes", "No"]}
